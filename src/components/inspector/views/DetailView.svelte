<script lang="ts">
  ...
  import PropertyGroup from '../sections/PropertyGroup.svelte';
  import PropertyRow from '../fields/PropertyRow.svelte';
  import EditablePropertyRow from '../fields/EditablePropertyRow.svelte';
  import EditableValue from '../fields/EditableValue.svelte';
  import CodeBlock from '../renderers/CodeBlock.svelte';
  import MarkdownValue from '../renderers/MarkdownValue.svelte';
  import AdditionalData from '../fields/AdditionalData.svelte';
