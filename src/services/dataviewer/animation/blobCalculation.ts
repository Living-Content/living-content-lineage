/**
 * Blob calculation utilities for liquid blob animation.
 * Handles blob generation, coverage detection, and positioning.
 */
...
export const getAnimConfig = (width: number, height: number): AnimConfig => {
...
/**
 * Calculates blob positions to fill a given area.
 */
export const calculateBlobs = (
  width: number,
  height: number,
  existingBlobs: Blob[] = []
): Blob[] => {
